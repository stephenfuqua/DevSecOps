...
def get_portfolio_health(team: str, velocity: int) -> None:
    ...
    total_points = tickets_df[tickets_df["project"].isin(portfolio_list[team])].points.sum()
...
def build_health_report(data_standard: str, edfi_tools: str, ods_platform: str, team_b: str) -> None:
